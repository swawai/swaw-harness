...
- **WIN-BOOT-003 — Windows executable 运行时自包含。** Windows Bootstrap 发布的 Core、用户 CLI executable、Harness 管理 CLI executable 与 Harness GUI executable 均不得依赖用户另行安装的 C/C++ runtime；Windows 系统组件不属于该限制。
