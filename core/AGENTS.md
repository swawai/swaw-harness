...
- `data/admin/map/core/` 当前由 `core/protocol` 验证 SkillPath 和技能声明，并从同一 DataHome 的已安装模块中选择和校验 Module Release；Core dispatcher、资源空间 Resource 验证与其他 Harness 用户的技能图复制尚未实现。
